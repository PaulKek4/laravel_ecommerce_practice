...
<head>
    ...
    <title>SurfsideMedia Admin - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="route('admin.index')">
                ...
                <div class="sidebar-brand-text mx-3">SurfsideMedia Admin</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Products Manipulation</h6>
                        <a class="collapse-item" href="{{ route('product.index') }}">Add Products</a>
                        <a class="collapse-item" href="{{ route('product.list') }}">Products List</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCategories" class="collapse" aria-labelledby="headingCategories"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Categories Manipulation</h6>
                        <a class="collapse-item" href="{{ route('category.index') }}">Add Category</a>
                        <a class="collapse-item" href="{{ route('category.list') }}">Categories List</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseBrand" class="collapse" aria-labelledby="headingBrand"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Brands Manipulation</h6>
                        <a class="collapse-item" href="{{ route('brand.index') }}">Add Brand</a>
                        <a class="collapse-item" href="{{ route('brand.list') }}">Brands List</a>
                    </div>
                </div>
            </li>
        </ul>
           ...
           <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; AK-JP Website 2024</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
