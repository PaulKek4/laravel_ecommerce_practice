            ...
            <div class="mt-3 border rounded p-5">
                <form method="POST" action="/admin/product/store" enctype="multipart/form-data">
                    ...
                    <div class="mt-3">
                        ...
                        <textarea name="short_description" id="short_description" cols="10" rows="10" class="form-control"></textarea>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="number" name="featured" id="featured" class="form-control">
                    </div>
                    <div class="mt-3">
