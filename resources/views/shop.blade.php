                                                ...
                                                <li>
                                                    <div class="form-check ps-0 custome-form-check">
                                                        <input class="checkbox_animated check-it" id="br{{ $brand->id }}"
                                                         name="brands"@if(in_array($brand->id,explode(',',$q_brands))) checked = "checked" @endif
                                                         value="{{ $brand->id }}" type="checkbox" onchange="filterProductByBrand(this)">
                                ...
                                <div class="accordion-body category-scroll">
                                    <ul class="category-list">
                                           @foreach ($categories as $categorie)
                                                <li>
                                                    <div class="form-check ps-0 custome-form-check">
                                                        <input class="checkbox_animated check-it" id="ct{{ $categorie->id }}" name="categories"
                                                         @if(in_array($categorie->id,explode(',',$q_categories))) checked = "checked" @endif
                                                        value="{{ $categorie->id }}" type="checkbox"
                                                            onchange="filterProductByCategory(this)">
                                                        <label class="form-check-label">{{ $categorie->name }}</label>
                                                        <p class="font-light">({{ $categorie->products->count() }})</p>
                                                    </div>
                                                </li>
...
<form action="" id="frmfilter" method="GET">
    ...
    <input type="hidden" name="prange" id="prange">
</form>
@endsection
@push('scripts')
